      ...
      <div className="grid items-center gap-8 lg:gap-16 lg:grid-cols-2">
        ...
        <div className="z-10 flex flex-col gap-12">
          <div>
            ...
            <h2 className="mb-6 font-[family-name:var(--font-sans)] text-[clamp(2.8rem,4vw,3.8rem)] font-black leading-[0.88] tracking-[-0.03em] text-white uppercase drop-shadow-xl">
              About{" "}
