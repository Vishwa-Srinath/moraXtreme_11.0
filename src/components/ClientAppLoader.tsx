...
export default function ClientAppLoader({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      {/* Page content always rendered so assets (earth.gif etc.) start loading immediately */}
      <div style={{ visibility: loading ? "hidden" : "visible" }}>
        {children}
      </div>

      {/* Loading overlay sits on top while timer runs */}
      {loading && (
